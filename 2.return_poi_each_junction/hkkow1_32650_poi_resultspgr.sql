...
-- in this script, it applies to kowloon area (kow1) in hk, with 92362 junctions

-- FISRT, SINCE THIS COMPUTER DOESN'T HAVE ENOUGH MEMORY TO RUN THE ENTIRE TABLE,
-- WE BREAK THE JUNCTIONS IN 9 SETS OF AROUND 10,000s

-- 0-10,000 - RETURN_POI_EACH_JUNCTION 1
-- pgr_withPointsDD() / network buffer query with no bounding box for first 10,000 junctions
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr1 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
'SELECT id AS pid, edge_id, fraction
 FROM jz_handover.hkkow1_32650_poi_buf500 WHERE edge_id IS NOT NULL',
 /*the following line selects the first 10,000 junctions as starting points.*/
 (SELECT ARRAY (SELECT id FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1_vertices_pgr WHERE id <= 10000 ORDER BY id)),400,
 directed := false,
 details := true)
)
...
FROM all_nodes AS n
INNER JOIN jz_handover.hkkow1_32650_poi_buf500 as p
on n.node = p.pid;
/*Query returned successfully in 16 min 13 secs.*/
...
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr2 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
'SELECT id AS pid, edge_id, fraction
 ...
 (SELECT ARRAY (SELECT id FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1_vertices_pgr
...
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr3 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
...
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr4 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
...
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr5 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
...
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr6 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
...
-- pgr_withPointsDD() / network buffer query with no bounding box for 2nd 10,000 junctions
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr7 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
...
-- pgr_withPointsDD() / network buffer query with no bounding box for 2nd 10,000 junctions
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr8 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
...
-- 80,001-end RETURN_POI_EACH_JUNCTION 9
-- pgr_withPointsDD() / network buffer query with no bounding box for 2nd 10,000 junctions
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr9 AS
WITH all_nodes as(
SELECT * FROM pgr_withPointsDD(
'SELECT id AS id, source, target, cost
 FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1 ',
'SELECT id AS pid, edge_id, fraction
 ...
 (SELECT ARRAY (SELECT id FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1_vertices_pgr
   WHERE id > 80000 ORDER BY id)),400,
 directed := false,
 details := true)
)
/*n.start_vid is the starting junctions, pid are the poi ids, pid_geom are the geom of pois*/
...
CREATE TABLE jz_handover.hkkow1_32650_poi_resultspgr AS
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr1
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr2
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr3
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr4
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr5
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr6
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr7
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr8
UNION
SELECT * FROM jz_handover.hkkow1_32650_poi_resultspgr9;
/*Query returned successfully in 2 min 24 secs.*/

-- FINDING THE NODES WITH NO POIS ASSOCIATED WITH
CREATE TABLE jz_handover.hkkow1_32650_edges_buf500_vertices_no_pois AS
SELECT id, the_geom FROM jz_handover.hkkow1_32650_edges_buf500_noded_1_topo_1_vertices_pgr AS t1
	WHERE NOT EXISTS(SELECT id FROM jz_handover.hkkow1_32650_poi_resultspgr AS t2 WHERE t1.id = t2.id);
...
ALTER TABLE jz_handover.hkkow1_32650_poi_resultspgr ADD COLUMN cates VARCHAR(20);
UPDATE jz_handover.hkkow1_32650_poi_resultspgr 
	SET cates = 
