# =============================================================================
# this script is used for sensitivity analysis, without using weight decay funciton
...
algo_junction_scores_table = 'jz_handover.hknew_32650_algo_junction_scores_sa' # add "_sa" as suffix to indicate sensitivity analysis
algo_junction_scores_table_temp = 'hknew_32650_algo_junction_scores_sa_temp' #same as algo junction_scores, add "_sa" as suffix to indicate sensitivity analysis
