...
shop_weights = [0.5, 0.3, 0.1, 0.1]  # the length of the weights determines
...
major_transport_weights = [0.9, 0.1]
...
restaurant_weights = [0.5, 0.3, 0.1, 0.1]
...
entertainment_weights = [0.5, 0.3, 0.1, 0.1]
...
school_weights = [0.5, 0.3, 0.1, 0.1]
...
domestic_weights = [0.5, 0.3, 0.1, 0.1]
...
health_weights = [0.5, 0.3, 0.1, 0.1]
